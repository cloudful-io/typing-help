export type Database = {
  public: {
    Tables: {
      ...
      PracticeTexts: {Row: {id: number; owner_teacher_id: number | null; class_id: number | null; student_id: number | null; language: string; grade_level: number | null; duration_seconds: number; label: string | null; is_public: boolean | null; content: string; assigned_at: string | null; randomize_text: boolean; created_at: string}}
      ...
      app_stats: { Row: { id: number; character_count: number; updated_at: string } }
    }
  }
}
